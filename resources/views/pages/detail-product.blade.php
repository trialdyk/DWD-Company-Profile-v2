        ...
        <div class="container p-12">
            <div class="my-3">
                ...
                <div class="">
                    ...
                    <p class="text-center text-primary-black">
            ...
            <div class="my-3 flex flex-col">
                <h1 class="text-primary-black font-bold text-4xl flex my-12 justify-center">Produk Lainnya</h1>
                <div class="grid grid-cols-3 mx-auto gap-12">
                    <div class="flex flex-col">
                        <img src="Group 64.png" alt="" class="w-[200px] h-[200px] rounded-md" srcset="">
                        <h1 class="text-primary-black font-bold text-lg mx-auto text-center my-3">Kamera Kayu</h1>
                        <p class="text-primary-black w-[200px]">Lorem ipsum, dolor sit amet consectetur adipisicing...</p>
                    </div>
                    <div class="flex flex-col">
                        <img src="Group 64.png" alt="" class="w-[200px] h-[200px] rounded-md" srcset="">
                        <h1 class="text-primary-black font-bold text-lg mx-auto text-center my-3">Kamera Kayu</h1>

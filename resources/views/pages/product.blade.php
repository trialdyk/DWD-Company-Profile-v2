...
@section('content')
    ...
    <section class="bg-primary-black text-primary-silver min-h-[344px] py-[2.5rem] px-[15px] md:pl-[65px] w-full">
        <div class="grid grid-flow-col-1 md:grid-cols-2 md:gap-3 lg:gap-6">
            <div class="" data-aos="fade-right" data-aos-duration="800" data-aos-delay="500">
                ...
                <h3 class="text-md text-center md:text-left mb-2 lg:text-lg md:w-[70%]">We are specialized in designing
                    kitchens, wardrobes, Walking closets,</h3>
            </div>
    ...
    <section class="px-[10px] md:px-[40px] lg:px-[65px] my-[20px] md:my-[40px] lg:my-[65px]">
        <h1 data-aos="fade-up" data-aos-duration="800" data-aos-delay="300"
            class="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold flex justify-center">Product</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
            @foreach ($products as $product)
                <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="500"
                    class="mt-[20px] md:mt-[30px] lg:mt-[65px] flex">
                    ...
                    <div class="w-[50%] my-1 lg:my-3 ml-2 lg:ml-6">
                        <h1 class="font-bold mb-4">{{$product->name}}</h1>

...
@section('content')
    ...
    <section class="bg-primary-black text-primary-silver h-[344px] w-full flex justify-center items-center">
        <div class="text-center">
            <h1 class="mb-6 text-6xl font-bold">Contact Us</h1>
            <h3 class="text-lg">We value every feedback from our customers. Do you have any suggestions, feedback or experiences you'd like to share</h3>
        </div>
    </section>
    <!--End Head -->
    <!-- Content -->
    <section class="my-16 px-[65px] w-full grid grid-cols-2 gap-6 h-[450px]">
        <div class="col-span-1 rounded-lg h-full">
        ...
        <div class="bg-primary-black col-span-1 flex justify-center items-center rounded-lg h-full">
    ...
    <!-- Contact -->
    <section class="text-primary-silver grid mb-8 px-[65px] grid-cols-3 gap-8">
        <div class="h-[200px] rounded-md flex-col bg-primary-black">
            <div class="w-20 mx-auto m-4 flex justify-center items-center rounded-full bg-primary-silver text-primary-black h-20">
            ...
            <h6 class="text-center">Jl. Brigjend Syafiudin No. 19 Kecamatan Sukorambi, Jember, Indonesia</h6>
        </div>
        <div class="h-[200px] rounded-md flex-col bg-primary-black">
            <div class="w-20 mx-auto m-4 flex justify-center items-center rounded-full bg-primary-silver text-primary-black h-20">
            ...
            <h6 class="text-center">+6281249535754</h6>
        </div>
        <div class="h-[200px] rounded-md flex-col bg-primary-black">
            <div class="w-20 mx-auto m-4 flex justify-center items-center rounded-full bg-primary-silver text-primary-black h-20">
            ...
            <h6 class="text-center">dwdnetwork.id@gmail.com</h6>
        </div>
    </section>
    <!-- End Contact -->
